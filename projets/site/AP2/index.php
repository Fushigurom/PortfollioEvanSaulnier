        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav me-auto">
                <?php if (isset($_SESSION['user'])): ?>
                    ...
                    <li class="nav-item"><a class="nav-link" href="pages/calendrier.php">Calendrier</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/tarifs.php">Tarifs</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/contact.php">Contact</a></li>
                    <li class="nav-item"><a class="nav-link" href="pages/adherentsLister.php">Liste Adhérents</a></li>
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link active" href="index.php">Accueil</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/calendrier.php">Calendrier</a></li>
                <li class="nav-item"><a class="nav-link" href="pages/tarifs.php">Tarifs</a></li>
            ...
            <div class="d-flex">
                <?php if (isset($_SESSION['user'])): ?>
                    ...
                    <a href="pages/compte.php" class="btn btn-outline-light">Profil</a>
                <?php else: ?>
                    <a href="pages/connexion.html" class="btn btn-outline-light me-2">Connexion</a>
                    <a href="pages/inscription.html" class="btn btn-primary">Inscription</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
